  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
        <div>
          <h3 className="text-lg font-semibold text-brand-gray-900">Feature Management</h3>
          <p className="text-sm text-brand-gray-600">Assign features to services and manage pricing</p>
        </div>
...
export default ServiceFeaturesManager;
