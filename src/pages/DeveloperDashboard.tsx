...
console.log("milestone", milestones)
  ...
  // Dummy data
  const statsData = [
    { title: 'Total Projects', value: '8', icon: Building2, color: 'text-blue-600' },
...
console.log("project", projects)
  ...
  const earnings = [
    { project: 'Corporate Website', milestone: 'CMS Integration', amount: '$250', datePaid: '2024-06-30', status: 'Paid' },
    { project: 'E-commerce App', milestone: 'User Authentication', amount: '$350', datePaid: '2024-07-03', status: 'Paid' },
    { project: 'Real Estate CRM', milestone: 'Database Schema', amount: '$300', datePaid: '2024-07-05', status: 'Paid' },
    { project: 'Real Estate CRM', milestone: 'Dashboard UI', amount: '$400', datePaid: null, status: 'Pending' }
  ];

  const withdrawals = [
    { id: 1, amount: '$600', status: 'Paid', requestDate: '2024-07-08', paidDate: '2024-07-10' },
    { id: 2, amount: '$450', status: 'Paid', requestDate: '2024-06-25', paidDate: '2024-06-27' },
    { id: 3, amount: '$300', status: 'Pending', requestDate: '2024-07-12', paidDate: null }
  ];

  const notifications = [
    { type: 'Project Assigned', message: 'New project "Restaurant POS" has been assigned to you', time: '2 hours ago', status: 'new' },
    { type: 'Milestone Approved', message: 'Database Schema milestone approved for Real Estate CRM', time: '1 day ago', status: 'success' },
    { type: 'Payment Made', message: '$300 payment processed for Real Estate CRM milestone', time: '3 days ago', status: 'success' },
    { type: 'Offer Review', message: 'Your offer for E-commerce App is under review', time: '5 days ago', status: 'pending' }
  ];
            ...
            {projects.slice(0, 3).map((project) => (
              <div key={project.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-medium text-gray-900 truncate">{project.briefSnippet}</p>
            ...
            {notifications.slice(0, 3).map((notification, index) => (
              <div key={index} className="flex items-start space-x-3">
                <div className={`w-2 h-2 rounded-full mt-2 ${
                  ...
                  notification.status === 'pending' ? 'bg-yellow-500' : 'bg-blue-500'
                }`} />
                <div className="flex-1 min-w-0">
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="hidden sm:table-cell">Estimated Cost</TableHead>
              ...
              <TableBody>
                {earnings.map((earning, index) => (
                  <TableRow key={index}>
                    ...
                    <TableCell className="font-semibold text-green-600">{earning.amount}</TableCell>
                    <TableCell className="hidden sm:table-cell">{earning.datePaid || 'Pending'}</TableCell>
              ...
              <TableBody>
                {withdrawals.map((withdrawal) => (
                  <TableRow key={withdrawal.id}>
                    ...
                    <TableCell className="hidden sm:table-cell">{withdrawal.requestDate}</TableCell>
                    <TableCell className="hidden md:table-cell">{withdrawal.paidDate || 'N/A'}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Stay updated with project and payment notifications</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Sidebar */}
      <div className={`fixed left-0 top-0 h-full w-64 bg-white border-r border-gray-200 shadow-sm z-50 transform transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}>
      ...
      <div className="lg:ml-64 p-4 lg:p-8">
        <div className="flex items-center justify-between mb-6 lg:mb-8">
          <div className="flex items-center space-x-4">
            ...
            <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Partner Dashboard</h1>
          </div>
          <div className="flex items-center space-x-2 lg:space-x-4">
            ...
            <div className="w-7 h-7 lg:w-8 lg:h-8 bg-blue-600 rounded-full flex items-center justify-center">
              <span className="text-white text-xs lg:text-sm font-semibold">P</span>
            </div>
          </div>
        </div>
