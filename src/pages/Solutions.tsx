...
const Solutions = () => {
  const solutions = [{
    ...
    description: 'Transform your business ideas into powerful digital solutions that drive growth and efficiency.',
    ...
    description: 'Build scalable platforms that generate recurring revenue and serve multiple customers efficiently.',
    ...
    description: 'Streamline your operations with comprehensive management interfaces for your business.',
    ...
    description: 'Enhance client relationships with secure portals that improve communication and transparency.',
    ...
    description: 'Boost productivity with comprehensive tools that keep your team organized and focused.',
    features: ['Task Automation', 'Time Tracking', 'Team Collaboration', 'Progress Reports'],
    color: 'from-purple-500 to-purple-600'
  }, {
    icon: Zap,
    title: 'Finance & Billing Modules',
    description: 'Automate your financial processes and gain insights that help your business thrive.',
    ...
    description: 'Deliver exceptional customer service with organized support platforms that resolve issues efficiently.',
    features: ['Ticket Management', 'Live Chat', 'Knowledge Base', 'SLA Tracking'],
    color: 'from-green-500 to-green-600'
  }, {
    icon: Globe,
    title: 'Progressive Web Apps (PWA)',
    description: 'Reach customers anywhere with mobile-first applications that work seamlessly across all devices.',
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            {solutions.map((solution, index) => <div key={index} className="bg-white border border-brand-gray-200 rounded-2xl p-8 hover:shadow-2xl transition-all duration-500 hover:border-brand-primary/30 group animate-slide-up" style={{
      ...
      <section className="py-20 bg-brand-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 max-w-5xl mx-auto">
            {['React', 'TypeScript', 'Node.js', 'PostgreSQL', 'AWS', 'Docker'].map((tech, index) => <div key={index} className="bg-white rounded-xl p-6 text-center shadow-md hover:shadow-lg transition-shadow duration-300 group">
